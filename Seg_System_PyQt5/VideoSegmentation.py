...
class VideoSegmentation_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox.setGeometry(QtCore.QRect(160, 30, 111, 21))
        ...
        self.label.setGeometry(QtCore.QRect(110, 30, 41, 16))
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(Form)
        self.pushButton.setGeometry(QtCore.QRect(100, 0, 56, 21))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.open_file)
        self.lineEdit = QtWidgets.QLineEdit(Form)
        self.lineEdit.setGeometry(QtCore.QRect(160, 0, 241, 20))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton_2 = QtWidgets.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(550, 30, 56, 21))
        self.pushButton_2.setObjectName("pushButton")
        self.pushButton_3 = QtWidgets.QPushButton(Form)
        self.pushButton_3.setGeometry(QtCore.QRect(550, 0, 56, 21))
        self.pushButton_3.setObjectName("pushButton")


        self.btn_play = QtWidgets.QPushButton(Form)
        self.btn_play.setGeometry(QtCore.QRect(270, 430, 50, 50))
        self.btn_play.setObjectName("btn_play")
        self.btn_stop = QtWidgets.QPushButton(Form)
        self.btn_stop.setGeometry(QtCore.QRect(380, 430, 50, 50))
        self.btn_stop.setObjectName("btn_stop")

        self.wgt_video = myVideoWidget(Form)
        self.wgt_video.setGeometry(QtCore.QRect(150, 70, 450, 300))
        self.wgt_video.setObjectName("wgt_video")

        self.btn_open = QtWidgets.QPushButton(Form)
        self.btn_open.setGeometry(QtCore.QRect(160, 430, 50, 50))
        ...
        self.sld_video.setGeometry(QtCore.QRect(180, 380, 251, 20))
        ...
        self.lab_video.setGeometry(QtCore.QRect(490, 380, 91, 20))
